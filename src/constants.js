...
// 발동 시 플랫폼 블록을 "돌아가는" 최단 경로(그리드 BFS)를 계산해 그 경로를 따라
// 중력 무시로 날아간다. 돌아가는 경로 길이가 감지범위×2를 넘으면(예산 초과)
// 발동하지 않고 그냥 걸어간다 — ×2는 이 우회 여유분이다.
export const DASH_ROUTE_MULT = 2;       // 경로 예산 = DETECT_RANGE.vampire × 2
